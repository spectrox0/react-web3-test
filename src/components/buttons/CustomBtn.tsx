...
export const CustomBtn: FCC<CustomBtnProps> = ({
  ...
  return (
    <button
      type="button"
      className={`flex justify-center items-center gap-1 border leading-tight
      text-xs font-medium py-2.5 outline-0 ring-0 px-3
      ...
      disabled:text-gray-500 disabled:border-gray-500 disabled:cursor-default  disabled:bg-gray-600/20 text-xs
      ${className}`}
      {...rest}
    >
      {children}
